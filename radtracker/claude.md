...
> **Mammo 新增量上修註（2026-05-25）**：W22 起 user 回報 Mammo 每週新增約 90 件（遠高於先前估的 46）。單週完成 ~115 件僅能淨減 ~25，**Mammo backlog 難在單週清空**，需連續數週每週完成 >90 才能壓低。場地限制（一/六 18:00 後、五 21:00 後）是 Mammo 產能瓶頸。
