...
> 🔴 **週六上班週的 Mammo 地板（2026-08-10 確認）**：週六到佳里上班時，當天會新增 **Mammo 15–20 件 + US ~12 件**。US 可當日消化（週六有排 US），但 **Mammo 沒有任何窗口**——週末場地零、週五晚已過、下一個窗口是下週一。
> ⇒ **週六上班週的 Mammo 期末天生有 ~17 件地板**，這不是排程失誤，排程時直接把它算進預測，不要試圖排掉。
