# lecture-pipeline-cli Specification
...
- **THEN** the command exits 0 and lists the subcommands transcribe, calibrate-subs, frames, ocr, condense, scaffold, render, viewer, pbf, hub, check, migrate, run, publish, convert-model, profile, install-skill
