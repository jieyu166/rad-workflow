...
HotstringMenuV("A","MenuShortcut"
    ...
    ,"A <6mm solid nodule in _.(Srs/Img:_/_)"
    ,"BRK"
    ...
    ,"A <10mm juxtapleural nodule in _.(Srs/Img:_/_)"
    ,"BRK"
	,"Subsegmental airway nodules in _.(Srs/Img:_/_)"
    ,"<6mm solid nodules in _.(Srs/Img:_/_)"
    ,"<6mm solid nodules in both lungs.(Arrows in Srs:_)"
    ,"<6mm ground-glass nodules in both lungs.(Arrows in Srs:_)"
    ,"<6mm solid, ground-glass nodules in both lungs.(Arrows in Srs:_)"
    ,"<4mm nonspecific nodules in both lungs.(Arrows in Srs:_)"
    ,"Stable <6mm solid and subsolid nodules in both lungs.(Arrows in Srs:_)"
    ,"BRK"
    ...
    ,"Suspect _ juxtapleural nodule or nodular atelectasis in _.(Srs/Img:_/_)")
return
...
HotstringMenuV("A","MenuShortcut"
    ...
    ,"BRK"
    ,"Borderline mediastinal LNs.(Srs/Img:_/_)"
