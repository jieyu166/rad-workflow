Use the provided images and OCR data to draft the requested radiology report.
Use the exam-specific output format below. The selected image mode determines whether temporal comparison is permitted.
